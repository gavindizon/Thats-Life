...
//        }
        ...
        this.spaces[8] = babySpaceRandomizer("career");
...
//
        ...
        this.spaces[77] = babySpaceRandomizer("family");
    ...
    /**
     * generates a random have kids space that is either HaveBaby or HaveTwin.
     * @param path String path of the space.
     * @return the randomly generated kids space.
     */

    private Space babySpaceRandomizer(String path){
        int rand = (int) (Math.random() * (2 - 1 + 1) + 1);

        switch (rand){
            case 1:
                return new HaveBabySpace(path, this.NUM_PLAYERS);
            default:
                return new HaveTwinSpace(path, this.NUM_PLAYERS);
        }
    }
