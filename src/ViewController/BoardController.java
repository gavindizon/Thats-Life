...
import Model.Player;
import Model.Spaces.*;
import Model.Spaces.GreenSpace.GreenSpace;
...
public class BoardController {
    ...
    public void boardAction(Game game, int currPlayerIndex, Controller gameControl) throws IOException {
        ...
        if(currSpace instanceof OrangeSpace || currSpace instanceof BlueSpace){
            ...
            }else if(magentaSpace instanceof GetMarriedSpace && !currPlayer.isMarried()) {
    ...
    private void choosePath(Player p, AnchorPane rootPane, String[] choices,
                           MagentaSpace magentaSpace, Game game, Controller gameControl, int stackCnt) throws IOException{
